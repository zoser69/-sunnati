...
const sunnahData = [
    ...
    },
    {
        ...
        items: [
            { id: 'adhkar_1', text: 'سيد الاستغفار (مرة صباحًا ومساءً)', evidence: '«اللَّهُمَّ أَنْتَ رَبِّي لا إِلَهَ إِلا أَنْتَ، خَلَقْتَنِي وَأَنَا عَبْدُكَ، وَأَنَا عَلَى عَهْدِكَ وَوَعْدِكَ مَا اسْتَطَعْتُ، أَعُوذُ بِكَ مِنْ شَرِّ مَا صَنَعْتُ، أَبُوءُ لَكَ بِنِعْمَتِكَ عَلَيَّ، وَأَبُوءُ لَكَ بِذَنْبِي فَاغْفِرْ لِي، فَإِنْهُ لا يَغْفِرُ الذُّنُوبَ إِلا أَنْتَ».', source: 'صحيح البخاري، حديث رقم 6306. (صحيح)', virtue: 'من قالها موقنًا بها فمات من يومه دخل الجنة، ومن قالها من ليلته فمات دخل الجنة.' },
    ...
    },
    {
        ...
        items: [
            ...
            { id: 'manners_4', text: 'دعاء الركوب والسفر', evidence: 'كان النبي صلى الله عليه وسلم إذا استوى على بعيره خارجًا إلى سفر كبر ثلاثًا ثم قال: «بِسْمِ اللهِ، الْحَمْدُ لِلَّهِ، {سُبْحَانَ الَّذِي سَخَّرَ لَنَا هَذَا وَمَا كُنَّا لَهُ مُقْرِنِينَ * وَإِنَّا إِلَى رَبِّنَا لَمُنْقَلِبُونَ}، الْحَمْدُ لِلَّهِ، الْحَمْدُ لِلَّهِ، الْحَمْدُ لِلَّهِ، اللَّهُ أَكْبَرُ، اللَّهُ أَكْبَرُ، اللَّهُ أَكْبَرُ، سُبْحَانَكَ إِنِّي ظَلَمْتُ نَفْسِي فَاغْفِرْ لِي، فَإِنْهُ لا يَغْفِرُ الذُّنُوبَ إِلا أَنْتَ».', source: 'سنن أبي داود (2602). (صححه الألباني)', virtue: 'استشعار نعمة الله بتسخير الدابة أو المركبة، وطلب المغفرة.' },
